...
% previously or they are obtained via another person. It is thus good practice 
% to always reset the bounds on the microbiome biomass fecal exchange, even if 
% it seems redudant. 
...
% _getMissingDietModelHM.m_. The function opens up the bounds on all dietary reactions 
...
% * missingDietComponents - List of diet exchange reactions that are known to 
% be missing or that have been identified in a previous run of this function. 
% We set this to an empty cell array as we have no previous known identified reactions.
% * testInitialFeasibility - Boolean to see if an initial feasibility test should 
% be run. We set this to 0 as we already did this beforehand.
